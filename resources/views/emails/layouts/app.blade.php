                      ...
                      <tr>
                        <td valign="top">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-p-30 pc-xs-p-20" bgcolor="#1b1b1b" valign="top" style="padding: 29px 35px; background-color: #1b1b1b; font-size: 0">
                                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td align="center" valign="top">
                                          <a href="http://devitup.co.uk" style="text-decoration: none;"><img src="http://staging.devitup.co.uk/img/logo.png" width="85" height="0" alt="DevItUp Logo" style="height: auto; max-width: 100%; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; color: #ffffff; font-size: 14px;"></a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <tr>
                                <td class="pc-sm-p-35-10-15 pc-xs-p-25-0-5" style="padding: 40px 20px 20px; background-color: #ffffff" valign="top" bgcolor="#ffffff">
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" style="padding: 0 20px; text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 400; line-height: 1.42; letter-spacing: -0.4px; color: #151515;" valign="top">
                                          @yield('content')
                                        </td>
                                      </tr>
                                      <tr>
                                                ...
                                                <tr>
                                                  <td style="padding: 20px;" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 500; line-height: 24px; letter-spacing: -0.2px; color: #ffffff;" valign="top">DevItUp</td>
                                                        </tr>
                                                        <tr>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; letter-spacing: -0.2px; color: #D8D8D8;" valign="top">Bringing people software solutions to help achieve their business goals. Whether it be a website, app or bespoke program.</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <tr>
                                                  <td style="padding: 20px;" valign="top">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 500; line-height: 24px; letter-spacing: -0.2px; color: #ffffff;" valign="top">
                                                            Contact us.
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; letter-spacing: -0.2px; color: #D8D8D8;" valign="top">17A Studland Road, Fareham, PO13 9HY</td>
                                                        </tr>
                                                        <tr>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 500; line-height: 24px; letter-spacing: -0.2px;" valign="top">
                                                            <a href="tel:07783629303" style="text-decoration: none; color: #ffffff;">07783629303</a>
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 500; line-height: 24px;" valign="top">
                                                            <a href="mailto:enquiries@devitup.co.uk" style="text-decoration: none; color: #9dc8db">enquiries@devitup.co.uk</a>
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
